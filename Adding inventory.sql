DROP TABLE IF EXISTS Inventory, BasementRats, UserRoles, Taverns, Locations, Users, Roles;
...
Create table Inventory(Name varchar (100), Quantity int, Unit varchar(100), LastDate datetime, TavernID int);
...
-- How do i show "what a tavern received"
